...
public class SecHubFinding {
    ...
    public String toString() {
        return "SecHubFinding [id=" + id + ", description=" + description + ", hostnames=" + hostnames + ", created=" + created + ", createdBy=" + createdBy
                + ", name=" + name + ", parameters=" + parameters + ", path=" + path + ", parameterName=" + parameterName + ", query=" + query + ", references="
                + references + ", method=" + method + ", request=" + request + ", resolution=" + resolution + ", response=" + response + ", service=" + service
                + ", severity=" + severity + ", target=" + target + ", website=" + website + ", code=" + code + ", productResultLink=" + productResultLink
                + "]";
    }
}
