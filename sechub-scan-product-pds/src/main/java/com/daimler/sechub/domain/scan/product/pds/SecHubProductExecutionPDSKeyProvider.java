...
public enum SecHubProductExecutionPDSKeyProvider implements PDSKeyProvider<SecHubProductExecutionPDSKey> {
    ...
    TIME_TO_WAIT_FOR_NEXT_CHECKOPERATION_IN_MILLISECONDS(new AdapterSetupKey(PDSProductExecutorKeyConstants.TIME_TO_WAIT_NEXT_CHECK_MILLIS,
    ...
    TIME_TO_WAIT_BEFORE_TIMEOUT_IN_MINUTES(new AdapterSetupKey(PDSProductExecutorKeyConstants.TIME_OUT_IN_MINUTES,
    ...
    TRUST_ALL_CERTIFICATES(new AdapterSetupKey(PDSProductExecutorKeyConstants.TRUST_ALL_CERTIFICATES,
    ...
    private static ForbiddenTargetTypeKey createSupportTargetType(TargetType type) {
        return new ForbiddenTargetTypeKey("pds.productexecutor.forbidden.targettype." + type.name().toLowerCase(),
