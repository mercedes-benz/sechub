...
@ActiveProfiles({ "oauth2-enabled", "classic-auth-enabled" })
class LoginControllerOAuth2AndClassicAuthEnabledTest {
    ...
    @Autowired
    LoginControllerOAuth2AndClassicAuthEnabledTest(MockMvc mockMvc, OAuth2Properties oAuth2Properties, ServerProperties serverProperties) {
