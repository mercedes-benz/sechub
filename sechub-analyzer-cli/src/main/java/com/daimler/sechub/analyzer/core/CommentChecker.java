...
public class CommentChecker {
    ...
    private void initialize() {
         ...
         *
         * (<!--|--|#|/\\*|//) -> the string has to contain a comment. Different
         * programming languages use different comment styles.
         *
         * ([-#/*\\s]+)? -> the string can contain further comment symbols or white
         * spaces. ATTENTION: The `-` has to be at the beginning of the group.
         *
         * (" + noSecHubLabel + "|" + endNoSecHubLabel + ") -> look for SecHub marker
         * labels.
         *
         * (\\s|-|$)+ -> accepts a line end as well as any whitespace or `-` minus
         * symbols after the SecHub marker label.
         */
     ...
     *
     * The comment check compiles a regular expression. Make sure you do not call
     * the buildFrom method too many times, otherwise it may cause performance
     * issues.
     *
