...
The script authentication mechanism using the SecHub templates and assets feature requires the following file to be present at execution time of the script to work:
----
