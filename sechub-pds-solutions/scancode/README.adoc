...
+
----
docker-compose --file docker-compose_pds_scancode_debian.yaml up --build
----
...
----
docker exec -it pds-scancode-debian bash
----
...
+
----
./10-create-debian-image.sh my.registry.example.org/sechub/pds_scancode_debian v0.1
----

. Using your own base image:
+
----
./10-create-debian-image.sh my.registry.example.org/sechub/pds_scancode_debian v0.1 "my.registry.example.org/debian:11-slim"
----
...
+
----
./20-push-image.sh my.registry.example.org/sechub/pds_scancode_debian v0.1
----

* Push the version and `latest` tags
+
----
./20-push-image.sh my.registry.example.org/sechub/pds_scancode_debian v0.1 yes
----
...
* `pds_scancode_debian` image pushed to registry
...
image:
   registry: registry.app.corpintra.net/sechub/pds_scancode_debian
   tag: latest
...
image:
   registry: my.registry.example.org/pds_scancode_debian
   tag: latest
