...
* `pds_scancode_ubuntu` image pushed to registry
...
image:
   registry: registry.app.corpintra.net/sechub/pds_scancode_ubuntu
   tag: latest
...
image:
   registry: my.registry.example.org/pds_scancode_ubuntu
   tag: latest
