...
+
----
./70-test-infrascan.sh <target-url or path-to-json-config-file>
----
+
For example:
+
----
./70-test-infrascan.sh https://my.juiceshop.org
----
+
or
+
----
./70-test-infrascan.sh my-scan-config.json
----
+
.my-scan-config.json
[source,json]
...
----
docker exec -it pds-infralight-debian bash
----
...
+
----
./10-create-image.sh my.registry.example.org/sechub/pds_infralight v0.1
----

. Using your own base image:
+
----
./10-create-image.sh my.registry.example.org/sechub/pds_infralight v0.1 "my.registry.example.org/debian:12-slim"
----
...
+
----
./20-push-image.sh my.registry.example.org/sechub/pds_infralight v0.1
----

* Push the version and `latest` tags
+
----
./20-push-image.sh my.registry.example.org/sechub/pds_infralight v0.1 yes
----
...
* `pds_infralight` image pushed to registry
...
image:
   registry: my.registry.org/sechub/pds_infralight
   tag: latest
...
+
----
helm install --values myvalues.yaml pds-infralight helm/pds-infralight/
----
+
[TIP]
...
pds-infralight-759ffc8dfb-8jj8f                    1/1     Running   0          75s
----

. Forward port of one of the pods to own machine
+
----
kubectl port-forward pds-pds_infralight-759ffc8dfb-8jj8f 8444:8444
----
...
----
helm upgrade --values my-values.yaml pds-infralight helm/pds-infralight/
----
...
pds-infralight                 	my-namespace	1       	2021-11-05 18:42:23.613991303 +0100 CET 	deployed	pds-infralight-0.1.0            	0.24.0
----

. Helm uninstall
+
----
helm uninstall pds-infralight
----
...
+
----
kubectl describe pod pds-infralight-759ffc8dfb-8jj8f
…
Events:
  Type    Reason     Age    From               Message
  ----    ------     ----   ----               -------
  Normal  Scheduled  6m52s  default-scheduler  Successfully assigned sechub-zap/pds-infralight-759ffc8dfb-8jj8f to c06p043-md-cc8c675cb-bqtpb
  ...
  Normal  Created    6m30s  kubelet            Created container pds-infralight
  Normal  Started    6m30s  kubelet            Started container pds-infralight
----

* Access container logs.
+
----
kubectl logs pds-infralight-759ffc8dfb-8jj8f
...
2021-11-05 17:42:47.697  INFO 7 --- [           main] d.s.p.ProductDelegationServerApplication : Starting ProductDelegationServerApplication using Java 11.0.11 on pds-infralight-759ffc8dfb-8jj8f with PID 7 (/pds/sechub-pds-0.24.0.jar started by zap in /workspace)
