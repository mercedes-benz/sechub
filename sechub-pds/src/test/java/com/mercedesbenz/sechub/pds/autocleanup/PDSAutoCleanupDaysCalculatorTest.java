...
class PDSAutoCleanupDaysCalculatorTest {

    private PDSAutoCleanupDaysCalculator calculatorToTest;

    @BeforeEach
    void beforeEach() {
        calculatorToTest = new PDSAutoCleanupDaysCalculator();
    }
    ...
    void days_calculated_as_expected(int amount, String unit, long expectedDays) {
        ...
        PDSAutoCleanupConfig config = PDSAutoCleanupConfig.fromString(json);
