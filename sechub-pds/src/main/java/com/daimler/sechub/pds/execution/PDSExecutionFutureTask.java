...
/**
 * A special future task, which calls {@link PDSExecutionCallable#prepareForCancel(boolean)} before
 * doing cancel operation - so it's possible to terminate process etc. before thread is interrupted
