...
public class CodingRulesTest {
    ...
    void beforeEach() {
        importedClasses = new ClassFileImporter().withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
                ...
                .withImportOption(ignoreNessusAdapter).withImportOption(ignoreNessusProduct).withImportOption(ignoreNetsparkerAdapter)
                .withImportOption(ignoreNetsparkerProduct).importPath("../../sechub/");
    }
    ...
    @Test
    void classes_should_not_should_use_deprecated_members() {
        /* execute + test */
    ...
    void classes_should_not_use_standard_streams() {
        ...
        importedClasses = new ClassFileImporter().withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_TESTS)
                .withImportOption(ImportOption.Predefined.DO_NOT_INCLUDE_JARS).withImportOption(ignoreTests).withImportOption(ignoreOpenAPI)
                .withImportOption(ignoreIntegrationTest).withImportOption(ignoreDocGen).withImportOption(ignoreDevelopertools).withImportOption(ignoreTools)
                .withImportOption(ignoreBuildSrc).importPath("../../sechub/");
        /* execute + test */
