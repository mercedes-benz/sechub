...
A potential successor project, Vufio (not from Mercedes-Benz), is currently under development but it is still in its early stages. Those interested can find more information at:
