...
public abstract class AbstractAwsS3Storage implements Storage {

    private static final Logger LOG = LoggerFactory.getLogger(AbstractAwsS3Storage.class);
     ...
     */
    public AbstractAwsS3Storage(AmazonS3 client, String bucketName, String storagePath, String storageId) {
        this(client, bucketName, storagePath, storageId, null);
    }
     ...
     */
    public AbstractAwsS3Storage(AmazonS3 client, String bucketName, String storagePath, String storageId, TransferManagerFactory transferManagerFactory) {
