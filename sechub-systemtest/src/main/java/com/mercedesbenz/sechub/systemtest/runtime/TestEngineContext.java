...
import com.mercedesbenz.sechub.systemtest.runtime.SystemTestRuntimeTestEngine.SecHubRunData;
...
class TestEngineContext {
    ...
    private void appendSecHubRunData() {
        ...
        SecHubConfigurationModel secHubConfiguration = this.systemTestRuntimeTestEngine.runSecHubJobTransformer.transformToSecHubConfiguration(runSecHubJobDefinition);
