...
public class IntegrationTestAIChat implements AIChat {
    ...
    public SecHubExplanationResponse explain(SecHubExplanationInput input) {
        ...
        /*
         * all other parts are not supported by this integration test pseudo AI chat -
         * means the fallback will be used instead
         */
        return null;
    }

    private SecHubExplanationResponse createCWE22Response() {
