...
- uses: mercedes-benz/sechub/github-actions/scan@master
    ...
    # OPTIONAL: 'Which version of the SecHub client to use. E.g `latest` or `1.10.0' or 'build'
    #            For debugging it is possible to use `build` which will NOT download
    #            a released version but instead use a local build! This can be useful for testing 
    #            unreleased versions. The option is not listed in official action.yml file.
    #
    # DEFAULT: latest
    version: 'latest'
    ...
    #           This is the reason why this parameter is not listed in official action.yml file.
    client-build-folder: ''
----
