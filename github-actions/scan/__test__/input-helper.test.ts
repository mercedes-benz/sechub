...
describe('resolveProxyConfig', function () {
    ...
    it('http_proxy and https_proxy defined - uses values of http_proxy', function () {
        /* prepare */
        process.env.http_proxy = 'http://user:password@proxy.example.org:1234';
    ...
    it('http_proxy and https_proxy defined - uses values of http_proxy no authentication section', function () {
        /* prepare */
    ...
    it('invalid http_proxy defined - throws error', function () {
        /* prepare */
    ...
    it('http_proxy defined without port - uses default port 443', function () {
        /* prepare */
        delete process.env.http_proxy;
        process.env.https_proxy = 'https://proxy.other.org';
