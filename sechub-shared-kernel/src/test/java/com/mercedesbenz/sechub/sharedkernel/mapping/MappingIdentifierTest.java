...
import static com.mercedesbenz.sechub.sharedkernel.mapping.MappingIdentifier.*;
...
public class MappingIdentifierTest {
    ...
    public void identifiers_are_constructed_without_initialization_failures() {
        /*
         * we just aqccess mappping identifier - if some body has implemented wrong
         * (e.g. duplicates or wrong ids) this will throw an exception at construction
         * time.
         */
