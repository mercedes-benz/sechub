...
class AnalyticDataTest {
    ...
    void analytic_data_with_code_parts_can_be_transformed_to_json_and_back() {
        ...
        codeAnalyticData.getProductData().setName("test-product");
        codeAnalyticData.getProductData().setVersion("0.2.3");
        ...
        /* test */
        CodeAnalyticData codeAnalyticData2 = result.getCodeAnalyticData();
        ...
        assertEquals("test-product", codeAnalyticData2.getProductData().getName());
        assertEquals("0.2.3", codeAnalyticData2.getProductData().getVersion());
    }
