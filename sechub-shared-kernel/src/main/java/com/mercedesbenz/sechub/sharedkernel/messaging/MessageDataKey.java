...
/**
 * A message data key represents data inside a message. Where the message itself
 * is represented by its {@link MessageID} the content inside the message is
 * represented by the {@link MessageDataKey}. Each key has an identifier but
 * also an provider which is able to convert data of message to corresponding
 * java type.
 *
