...
public enum MessageID {
    ...
    REQUEST_ASSIGN_TEMPLATE_TO_PROJECT(MessageDataKeys.PROJECT_TO_TEMPLATE),

    RESULT_ASSIGN_TEMPLATE_TO_PROJECT(MessageDataKeys.PROJECT_TEMPLATES),

    REQUEST_UNASSIGN_TEMPLATE_FROM_PROJECT(MessageDataKeys.PROJECT_TO_TEMPLATE),
