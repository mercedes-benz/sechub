...
public class AutoCleanupResult {
    ...
    private AutoCleanupResult(AutoCleanupResultKey key) {
        this.key = key;
    }
    ...
    public static class AutoCleanupResultBuilder {
        ...
        public AutoCleanupResult build() {
            ...
            AutoCleanupResult data = new AutoCleanupResult(key);
