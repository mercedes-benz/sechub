...
@UseCaseDefinition(
		id=UseCaseIdentifier.UC_ADMIN_FETCHES_ASSET_DETAILS,
		group=UseCaseGroup.CONFIGURATION,
		apiName="adminFetchAssetDetails",
		title="Admin fetches asset details",
...
public @interface UseCaseAdminFetchesAssetDetails {
