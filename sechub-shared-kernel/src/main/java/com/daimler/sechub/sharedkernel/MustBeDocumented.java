 ...
 * 
 * Following counter parts in conjunction with this annotation will result in <b>automated documentation</b>:
 * <ul>
 * <li>org.springframework.beans.annotation.Value</li> will be settled in gen_systemproperties.adoc
 * <li>org.springframework.scheduling.annotation.Scheduled</li> will be found in gen_scheduling.adoc
 * </ul>
 * Other parts are currently only a marker. Just implement more, to have more documentation generated...
