...
public enum UseCaseIdentifier {
	...
	/* executors */
	UC_ADMIN_ADDS_EXECUTOR_CONFIGURATION,
	
	UC_ADMIN_REMOVES_EXECUTOR_CONFIGURATION,
	
	UC_ADMIN_FETCHES_EXECUTOR_CONFIGURATION_LIST,
	
	UC_ADMIN_FETCHES_EXECUTOR_CONFIGURATION_SETUP,
	
	UC_ADMIN_UPDATES_EXECUTOR_CONFIGURATION_SETUP,
	
	UC_ADMIN_ENABLES_EXECUTOR_CONFIGURATION,
	
	UC_ADMIN_DISABLES_EXECUTOR_CONFIGURATION
	;
