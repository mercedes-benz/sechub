 ...
 * <br>
 * Only available for H2 profile usage. Also developers must enable the dedicated variant (TCP connection or web server variant).
 * Can be done by setting system properties: either "h2.web.enabled" or "h2.tcp.enabled"
