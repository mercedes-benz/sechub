...
import static com.mercedesbenz.sechub.adapter.AdapterException.*;
...
public class AdapterExceptionTest {
    ...
    @Test
    public void throwAsAdapterException_throws_adapter_exception_when_exception_is_runtime_exception() throws Exception {
        /* prepare */
    ...
    @Test
    public void throwAsAdapterException_throws_adapter_exception_with_traceid_when_exception_is_runtime_exception() throws Exception {
        /* prepare */
        RuntimeException cause = new RuntimeException();
