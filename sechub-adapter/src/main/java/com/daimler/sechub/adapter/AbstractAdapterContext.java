...
/**
 * Base context for adapter execution. Contains adapter config, adapter ,
 * runtime context and json adapter support. simple String as result).
 *
 * @author Albert Tregnaghi
 *
 */
public abstract class AbstractAdapterContext<C extends AdapterConfig, A extends Adapter<C>> implements AdapterContext<C> {
