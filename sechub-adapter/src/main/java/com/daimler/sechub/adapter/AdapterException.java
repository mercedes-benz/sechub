...
public class AdapterException extends Exception {
	...
	/**
	 * Throws given exception as adapter exception. If the exception is
	 * already an adapter exception the origin exception will be thrown (the
	 * given message and adapter idwill be ignored then)
	 * 
	 * @param message
	 * @param t
	...
	/**
	 * Returns an exception for given one.  If the exception is
	 * already an adapter exception the origin exception will be thrown (the
	 * given message and adapter idwill be ignored then) 
	 * @param id
	 * @param message
