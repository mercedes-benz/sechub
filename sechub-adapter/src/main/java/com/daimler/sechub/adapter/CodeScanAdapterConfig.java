...
public interface CodeScanAdapterConfig extends AdapterConfig {
     ...
     * 
     * For example, the folder paths are <code>src/java/</code> and <code>src/groovy</code>.
     * In this case, the method returns the target <code>src/java/;src/groovy</code> as string.
     * 
