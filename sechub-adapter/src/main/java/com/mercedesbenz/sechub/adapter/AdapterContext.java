...
public interface AdapterContext<C extends AdapterConfig> extends TraceIdProvider {
    ...
    /**
     * Gives back full API URL, containing of base url from configuration and given
     * api path
     *
     * @param apiPath
    ...
    /**
     * Gives back full API URL, containing of base url from configuration and given
     * api path. At the end of the url the map entries are added
     *
     * @param apiPath
     * @param map     - can be <code>null</code>
     * @return full API URL - e.g.
     *         "https://localhost/prefix/$apiPath?key1=value1&key2=value2"
     */
