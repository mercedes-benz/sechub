...
class SecHubOpenAPIConfigurationTest {
    ...
    /**
     * We have defined the json attribute "use" for the interface "SecHubDataConfigurationUsageByName"
     * but not for the class - here we check that the "use" attribute works as expected
     */
    @Test
