...
public class CheckmarxInstallSetupImpl extends AbstractInstallSetup implements CheckmarxInstallSetup {
    ...
    @Value("{sechub.adapter.checkmarx.engineconfiguration.name:"
            + CheckmarxEngineConfigurationOptions.DEFAULT_CHECKMARX_ENGINECONFIGURATION_MULTILANGANGE_SCAN_NAME + "}")
    @MustBeDocumented(value = "Checkmarx engine configuration name. "
            + "Possible values are documented in the checkmarx REST API documentation: "
