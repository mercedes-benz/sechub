...
public class SecHubDirectCheckmarxResilienceConfiguration implements CheckmarxResilienceConfiguration {
    ...
    @MustBeDocumented("Maximum amount of possible retries for situations when a 400 bad request happened on Checkmarx server")
    ...
    @MustBeDocumented("Maximum amount of possible retries for situations when a 500 server internal error happened on Checkmarx server")
    ...
    @MustBeDocumented("Maximum amount of possible retries for situations when a network error happened on communication to Checkmarx server")
    ...
    @MustBeDocumented("Time to wait until retry is done when a network server happened on communication to Checkmarx server")
