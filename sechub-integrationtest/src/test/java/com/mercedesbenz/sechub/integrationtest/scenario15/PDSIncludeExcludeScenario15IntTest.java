...
public class PDSIncludeExcludeScenario15IntTest {
    ...
    @Rule
    public IntegrationTestSetup setup = IntegrationTestSetup.forScenario(Scenario15.class);
     ...
     */
    @Test
    public void pds_upload_binaries_extracts_automatically_only_wanted_parts_and_handles_includes_excludes() {
        /* @formatter:off */
     ...
     */
    @Test
    public void pds_upload_sources_extracts_automatically_only_wanted_parts_and_handles_includes_excludes() {
        /* @formatter:off */
