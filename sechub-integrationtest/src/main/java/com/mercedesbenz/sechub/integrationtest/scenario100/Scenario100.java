...
import static com.mercedesbenz.sechub.integrationtest.internal.IntegrationTestDefaultProfiles.PROFILE_100_PDS_PREPARE;
 ...
 * <pre>
 * PROJECT_1
 *  - has execution {@link IntegrationTestDefaultProfiles#PROFILE_100_PDS_PREPARE profile 100}, {@link IntegrationTestDefaultProfiles#PROFILE_100_PDS_PREPARE profile 100} assigned
 *
 ...
 *
 */
public class Scenario100 extends AbstractGrowingSecHubServerTestScenario implements PDSTestScenario {

    /**
     * User 1 is registered on startup, also owner and user of {@link #PROJECT_1}
     */
    public static final TestUser USER_1 = createTestUser(Scenario100.class, "user1");

    /**
     * Project 1 is created on startup, and has {@link #USER_1} +
     * {@link IntegrationTestDefaultProfiles#PROFILE_100_PDS_PREPARE
     * profile 100} prepare assigned
     */
    public static final TestProject PROJECT_1 = createTestProject(Scenario100.class, "project1");
    ...
    protected void initializeTestData() {
        ...
        initializer().
                ...
                addProjectIdsToDefaultExecutionProfile(PROFILE_100_PDS_PREPARE,PROJECT_1).
