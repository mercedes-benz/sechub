...
RUN addgroup --gid 2323 pds \
     && adduser --uid 2323 --disabled-password --ingroup pds pds

RUN apk update --no-cache && \
    apk add --no-cache wget openjdk11-jre-headless python3 py3-pip py3-ruamel.yaml
