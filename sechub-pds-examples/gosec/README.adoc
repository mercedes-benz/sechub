...
----
+
NOTE: This is an example output. The output can be very different in your scan. The output depends on the uploaded `ZIP` file.
...
+
----
./container-create.sh my.registry.example.org/sechub/pds_gosec v0.1
----

. Using your own base image:
+
----
./container-create.sh my.registry.example.org/sechub/pds_gosec v0.1 "my.registry.example.org/ubuntu:focal"
----

=== Push to Registry

----
./container-push.sh my.registry.example.org/sechub/pds_gosec v0.1
----
...
----
helm install --set imageRegistry=my.registry.example.org/sechub/pds_gosec --set dockerTag=v0.1 --generate-name pds-gosec/
----
