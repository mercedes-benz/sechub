    ...
    public class VulnerabilityFinder {
        ...
        private class SearchTracer {
            ...
            boolean done(SerecoVulnerability v, String description) {
                ...
                if (traceEnabled) {
                    LOG.debug("Inspect vulnerability({})type:{},severity:{},count={},description={}",vulnerabilityNumber, v.getType(), v.getSeverity(), count, description);
                }
                if (count > closestCount) {
                    ...
                    if (traceEnabled) {
                        LOG.debug("New closest count set({}) for type:{},severity:{},count={},description={}", vulnerabilityNumber, closest.getType(), closest.getSeverity(), closestCount,
                            description);
                    }
                }
        ...
        /**
         * Enable trace logging - shows inspection information in case of 
         * error handling / understanding of verification
         * 
