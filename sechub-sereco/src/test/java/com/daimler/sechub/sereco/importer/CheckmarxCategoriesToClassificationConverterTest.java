...
public class CheckmarxCategoriesToClassificationConverterTest {
	...
	public void classification_example1() {
		/* execute */
		SerecoClassification classification = converterToTest.convert("PCI DSS v3.2;PCI DSS (3.2) - 6.5.8 - Improper access control,OWASP Top 10 2013;A4-Insecure Direct Object References,OWASP Top 10 2017;A5-Broken Access Control",new SerecoClassification());
	...
	public void classification_example2() {
		/* execute */
		SerecoClassification classification = converterToTest.convert("FISMA 2014;Identification And Authentication,NIST SP 800-53;AC-3 Access Enforcement (P1)",new SerecoClassification());
