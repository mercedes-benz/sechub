...
public class ImportSupportTest {
	...
	/**
	 * This test is import for failure handling. When a product is not
	 * reachable its result will be an empty string, which shall lead
	 * to a critical finding about product problems.
	 */
	@Test
