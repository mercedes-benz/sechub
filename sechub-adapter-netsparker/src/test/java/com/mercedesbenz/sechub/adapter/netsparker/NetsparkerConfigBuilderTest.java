...
public class NetsparkerConfigBuilderTest {
    ...
    @Test
    /*
     * reason of to not fail: valid url, port can be determined. Its up to the
     * product to fail or to support this combination - and may change in future. So
     * keep stupid config as is.
     */
