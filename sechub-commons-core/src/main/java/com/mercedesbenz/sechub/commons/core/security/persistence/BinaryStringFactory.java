 ...
 * 
 * It can create {@link BinaryString} from differently encoded strings
 * and returns a sub-type of {@link BinaryString} based on the desired 
 * output encoding.
 * 
...
public class BinaryStringFactory {
    ...
    /**
     * Create a new {@link BinaryString} from a string which is in hexadecimal encoding.
     * 
     * The given string needs to be hexadecimal encoded.
     * 
     * For example: Given the string "616263" (orginal value "abc") it will decode it
