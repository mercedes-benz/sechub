...
public class SecretScanFalsePositiveStrategyTest {

    private SecretScanFalsePositiveStrategy strategyToTest;
    ...
    public void before() throws Exception {
        strategyToTest = new SecretScanFalsePositiveStrategy();
    ...
    public void vulnerability_is_found_when_locations_and_relevant_parts_are_same() {
        ...
        when(serecoFalsePositiveSupport.areBothHavingExpectedScanType(ScanType.SECRET_SCAN, metaData, vulnerability)).thenReturn(true);
