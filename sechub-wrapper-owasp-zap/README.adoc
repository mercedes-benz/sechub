...
Another possibility to deactivate certain rules is the environment variable below.
If this variable is available the file with rule references to deactivate will be ignored. This makes testing more flexible.
