...
class JWTSupportTest {
    ...
    private JWTSupport supportToTest = new JWTSupport();

    @ParameterizedTest
    @NullSource
    @EmptySource
    @ValueSource(strings = { " ", "12345", "1234.5678.91011", "gazde5237d.hw78287d32.di7g82dgiwegiafafea" })
    void invalid_values_isjwt_returns_false(String value) {
        /* execute + test */
        assertFalse(supportToTest.isJWT(value));
    }
    ...
    void valid_values_isjwt_returns_true(String value) {
        /* execute + test */
        assertTrue(supportToTest.isJWT(value));
    }
