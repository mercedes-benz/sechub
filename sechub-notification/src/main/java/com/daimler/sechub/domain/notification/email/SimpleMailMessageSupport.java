...
public class SimpleMailMessageSupport {
	...
	/**
	 * Describes the message in a short form - will only contain subject, followed by existing mail targets, and existing from and replyTo.
	 * But NEVER subject - because could contain sensitive data which should not be logged.
	 * @param message
