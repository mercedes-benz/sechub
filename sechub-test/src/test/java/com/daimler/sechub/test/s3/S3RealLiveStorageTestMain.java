 ...
 * check if the amazon client API does really work with your environment.
 * <br><br>
 * We have an automated test {@link AwsS3JobStorageTest} which uses s3mock to simulate
 * S3 buckets. So this main class should normally be not necessary - but is
 * just an ensurance it really works in production environment as expected.
 * <br><br>
 * You just have to provide your S3 credentials as environment variables. Look at
 * output failures - missing entries are explained there.
