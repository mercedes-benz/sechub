...
import com.daimler.sechub.test.DomainAccessSourceVisitor.DomainProblem;

/**
 * This test case checks that domain communication is only done from packages inside a domain but never between domains directly!
