...
class SecretValidatorPropertiesTest {
    ...
    void validator_config_file_is_null_throws_exception() {
        /* execute + test */
        assertThrows(IllegalArgumentException.class, () -> new SecretValidatorProperties(null, 5L));
    }
    ...
    void not_existing_validator_config_file_throws_exception() {
        ...
        /* execute + test */
        assertThrows(IllegalArgumentException.class, () -> new SecretValidatorProperties(notExisting, 5L));
    }
    ...
    void not_readable_validator_config_file_throws_exception() {
        ...
        /* execute + test */
        assertThrows(IllegalArgumentException.class, () -> new SecretValidatorProperties(notReadable, 5L));
    }
    ...
    void valid_properties_result_in_valid_configuration() {
        ...
        /* execute */
        SecretValidatorProperties properties = new SecretValidatorProperties(validConfigFile, 5L);
