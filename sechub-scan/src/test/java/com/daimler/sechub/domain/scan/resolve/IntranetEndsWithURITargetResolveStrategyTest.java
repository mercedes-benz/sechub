...
public class IntranetEndsWithURITargetResolveStrategyTest {
	...
	private static URI URI_HTTPS_SOMEWHERE_INTRANET_EXAMPLE_ORG_PORT_1234_WITH_PATH = URI.create("https://somewhere.intranet.example.org:1234/myapplication/web/NAV/client.aspx");
	...
	public void intranet_example_org_only() throws Exception{
		...
		assertEquals(new Target(URI_HTTPS_SOMEWHERE_INTRANET_EXAMPLE_ORG,TargetType.INTRANET), strategyToTest.resolveTargetFor(URI_HTTPS_SOMEWHERE_INTRANET_EXAMPLE_ORG));
		assertEquals(new Target(URI_HTTPS_SOMEWHERE_INTRANET_EXAMPLE_ORG_PORT_1234,TargetType.INTRANET), strategyToTest.resolveTargetFor(URI_HTTPS_SOMEWHERE_INTRANET_EXAMPLE_ORG_PORT_1234));
		...
		assertEquals(new Target(URI_HTTP_SOMEWHERE_INTX_EXAMPLE_COM,TargetType.INTERNET), strategyToTest.resolveTargetFor(URI_HTTP_SOMEWHERE_INTX_EXAMPLE_COM));
	...
	public void intranet_example_org__and_intx_example_com() throws Exception{
		...
		assertEquals(new Target(URI_HTTP_SOMEWHERE_INTX_EXAMPLE_COM,TargetType.INTRANET), strategyToTest.resolveTargetFor(URI_HTTP_SOMEWHERE_INTX_EXAMPLE_COM));
