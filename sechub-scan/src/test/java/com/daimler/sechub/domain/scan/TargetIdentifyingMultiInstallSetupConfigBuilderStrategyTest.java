...
public class TargetIdentifyingMultiInstallSetupConfigBuilderStrategyTest {
    ...
    public void setup_data_used_from_selected_target_type() {
        ...
        TargetIdentifyingMultiInstallSetupConfigBuilderStrategy strategyToTest = new TargetIdentifyingMultiInstallSetupConfigBuilderStrategy(setup,
                TargetType.INTRANET);
    ...
    private class TestAdapterConfigBuilder extends AbstractAdapterConfigBuilder<TestAdapterConfigBuilder, TestAdapterConfig> {
