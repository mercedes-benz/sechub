...
/**
 * Setup where a product is installed multiple times - target dependent. (E.g. for <b>INTRANET</b> there is another installation than for <b>INTERNET</b>)
...
public interface TargetIdentifyingMultiInstallSetup extends InstallSetup{
	...
	/**
	 * Returns <code>true</code> when installation has not a certificate from a wellknown CA
