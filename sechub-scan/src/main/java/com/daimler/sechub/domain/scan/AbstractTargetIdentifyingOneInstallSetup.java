...
/**
 * Abstract base class for scans where INTERNET and INTRANET scans will be done
 * by ONE installation. The installation must have the ability to to scan both
 * parts by using an identifier.
 *
