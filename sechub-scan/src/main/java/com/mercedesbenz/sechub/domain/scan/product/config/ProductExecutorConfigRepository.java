...
public interface ProductExecutorConfigRepository extends JpaRepository<ProductExecutorConfig, UUID> {
    /**
     * Fetches all configurations being enabled, having wished product identifier
     * and executor version and related to a profile which is enabled and related to
     * given project id
     *
     * @param projectId
     * @param identifier
