...
public class CheckmarxConstants {
    ...
    /**
     * This is the "client secret" which is listed at <a href=
    ...
    public static final String MAPPING_CHECKMARX_NEWPROJECT_TEAM_ID = "checkmarx.newproject.teamid.mapping";

    public static final String MAPPING_CHECKMARX_NEWPROJECT_PRESET_ID = "checkmarx.newproject.presetid.mapping";
