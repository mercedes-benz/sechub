...
import com.mercedesbenz.sechub.adapter.checkmarx.support.CheckmarxProjectSupport.InternalUpdateContext;
...
public class CheckmarxProjectSupportTest {
    ...
    public void engine_configurations_can_be_extracted() throws AdapterException {
        ...
        /* execute */
        List<CheckmarxEngineConfiguration> engineConfigurations = supportToTest.extractEngineConfigurationsFromGet(json_data,
                JSONAdapterSupport.FOR_UNKNOWN_ADAPTER);
    ...
    public void findEngineConfigurationByName() {
        ...
        /* execute */
        CheckmarxEngineConfiguration actualEngineConfiguration = supportToTest
                .findEngineConfigurationByName(CheckmarxConstants.DEFAULT_CHECKMARX_ENGINECONFIGURATION_MULTILANGANGE_SCAN_NAME, engineConfigurations);
