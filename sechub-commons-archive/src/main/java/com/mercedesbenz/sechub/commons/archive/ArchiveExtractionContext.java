 ...
 *
 * <p>
 * Each property is validated during the creation of an ArchiveExtractionContext
 * object to ensure they meet the required conditions.
 *
 * <p>
 * Example usage:
 *
...
public class ArchiveExtractionContext {
    ...
    public ArchiveExtractionContext(FileSize maxFileSizeUncompressed, long maxEntries, long maxDirectoryDepth, Duration timeout) {
