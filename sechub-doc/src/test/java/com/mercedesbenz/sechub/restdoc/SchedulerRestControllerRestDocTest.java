	    			...
	    			andDo(defineRestService().
                            ...
                            document(
                                        ...
                                        requestFields(
                                                ...
                                                fieldWithPath(PROPERTY_WEB_SCAN+"."+SecHubWebScanConfiguration.PROPERTY_HEADERS+"[]."+HTTPHeaderConfiguration.PROPERTY_SENSITIVE).description("Default is set to 'true'. If 'true' the header value will be replaced with '********' inside the report.").optional()
                                        ),
                                        responseFields(
                                                fieldWithPath(SchedulerResult.PROPERTY_JOBID).description("A unique job id")
                                        )
