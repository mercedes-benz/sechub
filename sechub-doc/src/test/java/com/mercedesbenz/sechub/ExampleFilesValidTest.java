...
class ExampleFilesValidTest {
    ...
    @ParameterizedTest
    @EnumSource(SecHubConfigExampleTestFile.class)
    void every_sechub_config_file_is_valid(SecHubConfigExampleTestFile file) {
        /* prepare */
    ...
    @ParameterizedTest
    @EnumSource(value = SecHubConfigExampleTestFile.class, names = { "WEBSCAN_ANONYMOUS", "WEBSCAN_BASIC_AUTH", "WEBSCAN_FORM_BASED_SCRIPT_AUTH",
    ...
    void every_sechub_config_webscan_file_is_valid_and_has_a_target_uri(SecHubConfigExampleTestFile file) {
        /* prepare */
        String json = TestFileReader.readTextFromFile(file.getPath());
    ...
    void webscan_anonymous_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_ANONYMOUS.getPath());
    ...
    void webscan_basic_auth_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_BASIC_AUTH.getPath());
    ...
    void webscan_form_based_script_auth_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_FORM_BASED_SCRIPT_AUTH.getPath());
    ...
    void webscan_openapi_with_data_reference_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_OPENAPI_WITH_DATA_REFERENCE.getPath());
    ...
    void webscan_client_certificate_with_data_reference_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_CLIENT_CERTIFICATE_WITH_OPENAPI.getPath());
    ...
    void webscan_client_certificate_with_openapi_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_CLIENT_CERTIFICATE.getPath());
    ...
    void webscan_header_scan_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_HEADER_SCAN.getPath());
    ...
    void webscan_header_from_data_reference_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_HEADER_FROM_DATA_REFERENCE.getPath());
    ...
    void webscan_form_based_script_auth_with_totp_can_be_read_and_contains_expected_config() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(SecHubConfigExampleTestFile.WEBSCAN_FORM_BASED_SCRIPT_AUTH_WITH_TOTP.getPath());
    ...
    void pds_param_template_metadata_array_syntax_example_is_valid() {
        /* prepare */
        String json = TestFileReader.readTextFromFile(PDSDataExampleTestFile.PDS_PARAM_TEMPLATE_META_DATA_SYNTAX.getPath());
