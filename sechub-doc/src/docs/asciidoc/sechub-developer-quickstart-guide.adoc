...
+
TIP: Issues have labels a good way to start is to look for issues with https://github.com/mercedes-benz/sechub/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22[`help wanted`] label.
