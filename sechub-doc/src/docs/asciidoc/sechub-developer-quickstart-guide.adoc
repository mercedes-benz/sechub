...
WARNING: If the version of your GoLang is below {required_go_version}, please install a more recent version from https://go.dev/dl/[here], because you can't compile the executables.
