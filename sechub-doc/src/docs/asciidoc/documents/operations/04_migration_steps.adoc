...
With Server v0.19.0 we upgraded our Spring Boot dependencies footnote:update_0_19_0[https://github.com/mercedes-benz/sechub/issues/472] but this led to cancelation problems on older jobs - 
