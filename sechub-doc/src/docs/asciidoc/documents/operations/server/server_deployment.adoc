...
===== Kubernetes
We provide a Helm chart for above container image: https://github.com/mercedes-benz/sechub/pkgs/container/sechub%2Fhelm-charts%2Fsechub-server
...
# edit "values.yaml" file and adapt settings
