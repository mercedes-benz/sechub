...
The name should provide information what the service does.

=== RestController
Rest controller should not do any business logic by themselves, but delegate only to dedicated
(rest) controller.
