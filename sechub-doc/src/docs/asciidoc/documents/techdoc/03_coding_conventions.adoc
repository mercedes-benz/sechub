...
=== YAML
Inside YAML files, we use following convention

- YAML files have the file ending `.yaml`
- define *SPDX header* with MIT license as first line comment
- use an *indention* of *2 spaces*
- define *strings* with *single apostrophes*
- define *integers*, *longs* etc. as *numbers*
