...
- apitoken `<string>` +
  The api token. Although you can pass it as a runtime option, it is recommended for security reasons to define the environment variable `SECHUB_APITOKEN` and not to use this option.
