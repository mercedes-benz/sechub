...
===== markFalsePositives
Read your report carefully and check which of the findings are really so called "false positives".
After this create an json file containing jobUUID and ID of finding you decided to be an FP. If 
...
===== getFalsePositives
This will fetch the false positive list of your project as JSON - format is same as for `markFalsePositives`
