...
Each entry can be updated or removed by the given `id`. Marking a projectData entry with a already existing `id` again, will update its content with the new data.
====
