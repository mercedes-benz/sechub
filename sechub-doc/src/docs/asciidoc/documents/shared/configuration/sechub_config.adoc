...
----
include::sechub_config_example24_logout_config.json[]
----
...
<2> `xpath` to locate the HTML element that shall be avoided during the scan
<3> `htmlElementType` to locate the HTML element that shall be avoided during the scan
