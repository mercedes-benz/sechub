...
<4> Client only option - if you use REST directly, you can ignore this. +
    Exclude directories (optional), syntax is similar to https://ant.apache.org/manual/Types/fileset.html[ANT fileset]. +
