...
And let us assume the used product has hundred of options which cannot be configured
...
----
<1> The type of the template. Possible: `webscan-login`
<2> Array with asset identifiers assigned to the template
<3> Variable definitions as map of key and type which can be mandatory or optional. 
