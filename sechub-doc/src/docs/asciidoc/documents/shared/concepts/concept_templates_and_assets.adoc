...
The {sechub} server will use the product identifiers (like in the executor configurations)
as filenames when storing asset data inside database (and also inside storage).
