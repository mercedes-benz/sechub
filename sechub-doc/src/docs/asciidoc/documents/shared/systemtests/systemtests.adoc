...
[IMPORTANT]
====
This example is just an example what steps could be configured at all. It is not 
used in any real world scenario  - just for documentation
====
[source,json]
----
include::../../gen/examples/gen_example_systemtest_full_blown_config.json[]
----
