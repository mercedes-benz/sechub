...
[source, shell]
--
include::sechub-getting-started/clone-repo.sh[]
--
...
[source, shell]
--
include::sechub-getting-started/start-sechub.sh[]
--
...
[source, shell]
--
include::sechub-getting-started/start-pds-gosec.sh[]
--
...
Here we set the local credentials because everything is hosted locally:

[source, shell]
--
include::sechub-getting-started/setup-project.sh[lines=1..5]
--
...
[source, shell]
--
include::sechub-getting-started/setup-project.sh[lines=7]
--
...
And to scan it, just type `sechub -project test-gosec scan`, this will create a JSON file, which contains a report of the findings from the scan. If you want HTML output just add `-reportformat html` as an option: `sechub -project test-gosec -reportformat html scan`
