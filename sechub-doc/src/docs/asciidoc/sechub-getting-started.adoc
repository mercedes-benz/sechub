...
We have prepared a mini-example in the "demo" folder.

Please have a look at the `sechub.json`. Here it is defined which files should be scanned, and which should be skipped.
