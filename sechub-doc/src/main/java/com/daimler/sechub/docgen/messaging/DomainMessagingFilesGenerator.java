...
public class DomainMessagingFilesGenerator {
	...
	public void generateMessagingFiles(File messagingFile, File diagramsGenFolder, DomainMessagingModel model
			) throws IOException {
		...
		generateMessagingPlantumlFile(diagramsGenFolder, reducedModelForOverview, "__Overview__ of domain **messaging** ",
				overviewName, MessageID.values());
	...
	private void generateMessagingPlantumlFile(File diagramsGenFolder, DomainMessagingModel model, String title,
			String targetFileName, MessageID[] messageIdsToInspect) throws IOException {
