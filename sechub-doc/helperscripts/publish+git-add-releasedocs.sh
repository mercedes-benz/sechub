...
function add_files(){
  ...
  case "$product" in
    ...
    pds)
      ...
      ;;
    server)
      files_to_add="sechub-architecture.html sechub-operations.html sechub-developer-quickstart-guide.html sechub-restapi.html sechub-techdoc.html server-download.html"
      ;;
    *)
