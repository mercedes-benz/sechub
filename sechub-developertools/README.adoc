...
This will generate a keycloak oauth properties file for your local sechub server. Add `-Dspring.profiles.active=local-keycloak` to your spring properties to use the generated properties file.
