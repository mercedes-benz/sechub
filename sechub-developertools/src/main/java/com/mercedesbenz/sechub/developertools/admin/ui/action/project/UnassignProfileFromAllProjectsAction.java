...
import com.mercedesbenz.sechub.developertools.admin.ui.action.config.ListExecutionProfilesDialogUI;
...
public class UnassignProfileFromAllProjectsAction extends AbstractUIAction {
    ...
    public void execute(ActionEvent e) {
        ...
        ListExecutionProfilesDialogUI dialogUI = new ListExecutionProfilesDialogUI(getContext(),
                "Select profile to unassign from all projects (" + list.size() + ")");
