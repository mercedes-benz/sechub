...
package com.mercedesbenz.sechub.developertools.admin.ui.action.developerbatchops;
...
public class DeveloperBatchCreateCheckmarxTestSetupAction extends AbstractUIAction {
    ...
    public void execute(ActionEvent e) {
        ...
        String postResult = getContext().getAdministration().createProject(projecIdentifier, "created for just for development purposes", userId, whiteListURLs,
                metaData);
